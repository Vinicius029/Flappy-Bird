...
//b.setAltura(400)
//cument.querySelector('[wm-flappy]').appendChild(b.elemento)
...
function Barreiras(altura, largura, abertura, espaco, notificarPonto){
    ...
    this.animar = () => {
        this.pares.forEach(par => {
            ...
            //quando elemento sair da área de jogo
...
barreiras.pares.forEach(par => {
    areaDeJogo.appendChild(par.elemento)
})
setInterval(() => {
    barreiras.animar()
    passaro.animar()
...
function Progresso(){
    ...
    this.atualizarPontos = p => {
        this.elemento.innerHTML = p
    }
